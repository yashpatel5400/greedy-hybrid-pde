...
Method & $\|e^{(T)}_h\|/\|u_h\|$ & AUC & $p$ & $\|e^{(T)}_h\|/\|u_h\|$ & AUC & $p$ \\ \midrule
\multicolumn{7}{c}{Jacobi-related solvers} \\ \midrule
Solver only & 9.81e-01 (2.5e-03) & 2.97e+02 (4.0e-01) & $<10^{-3}$ & -- & -- & -- \\
HINTS ($\tau{=}25$) & 2.11e-06 (1.0e-06) & 2.40e+01 (1.5e-03) & $<10^{-3}$ & -- & -- & -- \\
Learned router (ours) & \textbf{2.07e-06 (1.0e-06)} & \textbf{2.34e-02 (1.0e-02)} & - & -- & -- & -- \\
Cost-aware oracle & \textit{2.07e-06 (1.0e-06)} & \textit{2.34e-02 (1.0e-02)} & \textit{-} & -- & -- & -- \\
\midrule
\multicolumn{7}{c}{GS-related solvers} \\ \midrule
Solver only & 9.63e-01 (4.4e-03) & 2.94e+02 (7.2e-01) & $<10^{-3}$ & -- & -- & -- \\
HINTS ($\tau{=}25$) & 9.59e-10 (6.1e-12) & 2.40e+01 (5.7e-03) & $<10^{-3}$ & -- & -- & -- \\
Learned router (ours) & \textbf{9.63e-10 (5.5e-12)} & \textbf{1.28e-02 (5.5e-03)} & - & -- & -- & -- \\
Cost-aware oracle & \textit{9.64e-10 (5.2e-12)} & \textit{1.28e-02 (5.5e-03)} & \textit{-} & -- & -- & -- \\
\midrule
\multicolumn{7}{c}{SOR (1.5)-related solvers} \\ \midrule
Solver only & 9.00e-01 (9.4e-03) & 2.84e+02 (1.7e+00) & $<10^{-3}$ & -- & -- & -- \\
HINTS ($\tau{=}25$) & 8.69e-10 (2.8e-11) & 2.39e+01 (1.7e-02) & $<10^{-3}$ & -- & -- & -- \\
Learned router (ours) & \textbf{9.19e-10 (1.2e-11)} & \textbf{6.70e-03 (2.9e-03)} & - & -- & -- & -- \\
Cost-aware oracle & \textit{9.38e-10 (1.0e-11)} & \textit{6.69e-03 (2.9e-03)} & \textit{-} & -- & -- & -- \\
\bottomrule
\end{tabular}}
\newcommand{\causageC}{
\begin{tabular}{llcccccc}
...
\bottomrule
\end{tabular}}
\newcommand{\caSpHintsCMin}{1.11$\times$}
\newcommand{\caSpHintsCMax}{3.10$\times$}
\newcommand{\caSpBestCMin}{1.11$\times$}
\newcommand{\caSpBestCMax}{1.24$\times$}
\newcommand{\caSpHintsDeepCMin}{1.00$\times$}
\newcommand{\caSpHintsDeepCMax}{1.37$\times$}
\newcommand{\caSpBestDeepCMin}{1.00$\times$}
\newcommand{\caSpBestDeepCMax}{1.09$\times$}
\newcommand{\caSpOracleRatioCMin}{1.01$\times$}
\newcommand{\caSpOracleRatioCMax}{1.06$\times$}
\newcommand{\caNumCellsC}{3}
\newcommand{\caCellsRouterBeatsBestC}{3}
\newcommand{\caCellsRouterBeatsHintsC}{3}
\newcommand{\caens}{
\begin{tabular}{llcccc}
\toprule
